<section class="home-dining-choose rel z-1 py-100 rpy-70">
    <div class="home-dining-choose__inner">
        <div class="text-center mb-55 rmb-40 wow fadeInUp delay-0-1s">
            ...
            <h2 class="home-dining-choose__title">Restaurant &amp; experience</h2>
            <p class="home-dining-choose__lead mx-auto">Discover our menu and what makes Martin Aviator the natural choice after your flight.</p>
        </div>
            ...
            <div class="home-dining-choose__col home-dining-choose__col--why wow fadeInRight delay-0-2s">
                <article class="home-dining-choose__card home-dining-choose__card--why h-100">
                    <div class="home-dining-choose__card-inner home-dining-choose__card-inner--why">
                        ...
                        <h3 class="home-dining-choose__card-title">Designed for travellers</h3>
                        <ul class="home-dining-choose__why-list">
                            <li><i class="fas fa-plane-arrival" aria-hidden="true"></i><span>Minutes from Kigali International Airport</span></li>
                            <li><i class="fas fa-mug-hot" aria-hidden="true"></i><span>Warm hospitality &amp; calm, comfortable spaces</span></li>
                            <li><i class="fas fa-shield-alt" aria-hidden="true"></i><span>Thoughtful service from arrival to departure</span></li>
                        </ul>
