                                ...
                                <form action="{{ route('saveSetting') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content ma-tab-body">
                                        ...
                                        <div class="tab-pane fade" id="tab-otas" role="tabpanel">
                                            ...
                                            <p class="form-text">Paste the entire <code>&lt;iframe&gt;...&lt;/iframe&gt;</code> snippet. On the contact page, print the saved HTML using Blade “raw” output for <code>google_map_embed</code> from your settings variable.</p>
                                        </div>
