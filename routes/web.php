...
Route::get('/about-delta-resort-hotel', [HomeController::class, 'aboutUs'])->name('aboutUs');
Route::get('/accommodation-at-delta-resort', [HomeController::class, 'rooms'])->name('rooms');
